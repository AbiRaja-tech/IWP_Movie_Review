...
$result = mysqli_query($mysqli, "SELECT * FROM reviewtab ORDER BY ID DESC");
?>
<body>
<!--preloading-->
<div id="preloader">
			...
			<div class="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav flex-child-menu menu-left">
					...
					<li class="dropdown first">
						<a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown" href="index.php">
						Home <!--<i class="fa fa-angle-down" aria-hidden="true"></i>
						</a>
						<!--
						<ul class="dropdown-menu level1">
							<li><a href="index-2.html">Home 01</a></li>
							<li><a href="index.php">Home 02</a></li>
							<li><a href="homev3.html">Home 03</a></li>
						</ul>
					</li>
					-->	
					<li class="dropdown first">
						<a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown" href="./moviegrid.html">
					...
					<li class="dropdown first">
						<a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown" href="./bloggrid.html">
		...
		<div class="row ipad-width2">
			...
			<div class="col-md-8 col-sm-12 col-xs-12">
				<div class="movie-single-ct main-content">
					<h1 class="bd-hd">Skyfall: Quantum of Spectre <span>2019</span></h1>
						        ...
						        <div id="reviews" class="tab review">
								    <div class="row">
						            	<div class="rv-hd">
							            	...
							            	<a href="ratemovie.php" class="redbtn">Write Review</a>
										</div>
										<?php
										while($user_data = mysqli_fetch_array($result)) {         
											echo '<div class="mv-user-review-item">';
										    echo '<div class="user-infor">';
											echo '<img src="images/uploads/userava4.jpg" alt="">';
											echo '<div>';
												echo '<h3>Just about as good as the first one!</h3>';
												echo '<p class="time">'.$user_data['moddate'].'<a href=""> by '.$user_data['username'].'</a>';
												echo '</p>';
											echo '</div>';
										    echo '</div>';
											echo '<p>'.$user_data['review'].'</p>';
										}
										?>
										<div class="mv-user-review-item">
										...
										<div class="mv-user-review-item">
											<div class="user-infor">
												...
												<div>
													...
													<p class="time">
														 26 March 2022 by<a href="#"> christopherfreeman</a>
													</p>
												</div>
											</div>
										...
										<div class="mv-user-review-item ">
											<div class="user-infor">
												...
												<div>
													...
													<p class="time">
														26 March 2022 by <a href="#"> juliawest</a>
													</p>
												</div>
											</div>
										...
										<div class="mv-user-review-item last">
											<div class="user-infor">
												...
												<div>
													...
													<p class="time">
														26 March 2022 by <a href="#"> johnnylee</a>
													</p>
												</div>
											</div>
	...
	<div class="container">
		<div class="flex-parent-ft">
			<div class="flex-child-ft item1">
				 ...
				 <p>VIT University<br>
				Vellore, TamilNadu</p>
				<p>Call us: <a href="#">+91 9750959777</a></p>
			</div>
