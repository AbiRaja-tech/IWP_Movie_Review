				...
				<div class="collapse navbar-collapse flex-parent" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav flex-child-menu menu-left">
						...
						<li class="dropdown first">
							<a class="btn btn-default dropdown-toggle lv1" data-toggle="dropdown" data-hover="dropdown" href="index.html">
						...
						-->	
						<li class="dropdown first">
							<a href="./moviegrid.php" class="btn btn-default dropdown-toggle lv1">
							...
							<ul class="dropdown-menu level1">
								...
								<li class="it-last"><a href="moviesingle.php">Movie single</a></li>
							</ul>-->
						</li>
						<!--<li class="dropdown first">
							<a class="btn btn-default dropdown-toggle lv1" href="./celebritygrid02.html">
						    ...
						    <!--</li>-->
						<li class="dropdown first">
							<a class="btn btn-default dropdown-toggle lv1" href="./bloggrid.html">
	    			...
	    			<div class="row">
	    				<div class="col-md-8 col-sm-12 col-xs-12">
	    					<div class="title-in">
			    				...
			    				<div class="mv-details">
			    					<p><i class="ion-android-star"></i><span>5</span> /5</p>
			    					<ul class="mv-infor">
			    						<li>  Run Time: 2h15’ </li>
			    						<li>  Rated: PG-13  </li>
			    						<li>  Release: 4 June 2019</li>
			    					</ul>
			    				</div>
			    				<div class="btn-transform transform-vertical">
			            	...
			            	<div class="slick-multiItem2">
			            		...
			            		<div class="slide-it">
			            			<div class="movie-item">
				            			...
				            			<div class="title-in">
				            				<h6><a href="#">Mulholland Drive</a></h6>
				            				<p><i class="ion-android-star"></i><span>5</span> /5</p>
				            			</div>
				            		</div>
			            		</div>
			            		<div class="slide-it">
			            			<div class="movie-item">
				            			...
				            			<div class="title-in">
				            				<h6><a href="#">2049</a></h6>
				            				<p><i class="ion-android-star"></i><span>3</span> /5</p>
				            			</div>
				            		</div>
			            		</div>
			            		<div class="slide-it">
				...
				<div class="latestnewv2">
					<div class="blog-item-style-2">
						...
						<div class="blog-it-infor">
							...
							<span class="time">27 Mar 2022</span>
